...
const Banner = () => {
  ...
  return (
    <div
      className={`bg-[#F8F8F8] py-16 w-full transition-all duration-300 ${
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex lg:flex-col gap-6 lg:gap-8 w-full lg:w-[35%]">
            <NavLink to="#">
              <img
                src={banner_2}
                alt="banner_img"
        ...
        <div className="bg-white rounded-2xl p-8 mt-10 lg:mt-14 shadow">
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="space-y-1">
                <h4 className="text-xl font-bold">Free Return</h4>
